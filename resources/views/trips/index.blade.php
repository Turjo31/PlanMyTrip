...
@section('content')
    <div class="trips-wrapper">
        ...
        <div class="filters">
            ...
            <a href="{{ route('trips.index', ['status' => 'planned']) }}"
                class="filter-btn {{ request('status') === 'planned' ? 'active' : '' }}">Planned</a>
            <a href="{{ route('trips.index', ['status' => 'ongoing']) }}"
                class="filter-btn {{ request('status') === 'ongoing' ? 'active' : '' }}">Ongoing</a>
